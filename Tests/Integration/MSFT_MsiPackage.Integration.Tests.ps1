            ...
            Context 'Set-TargetResource' {
                ...
                It 'Should correctly install and remove a package from a HTTP URL' {
                    ...
                    try
                    {
                        ...
                        Write-Verbose -Message "$([DateTime]::Now): Finished waiting for file server start2" -Verbose
                ...
                It 'Should correctly install and remove a package from a HTTPS URL' -Skip:$script:skipHttpsTest {
                    ...
                    try
                    {
                        ...
                        Write-Verbose -Message "$([DateTime]::Now): Finished waiting for file server start3" -Verbose
